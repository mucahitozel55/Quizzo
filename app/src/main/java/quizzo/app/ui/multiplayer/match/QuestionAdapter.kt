...
import kotlinx.android.synthetic.main.question_multi_layout.view.*
import quizzo.app.R
...
class QuestionAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QuestionViewHolder {
        return QuestionViewHolder(
            LayoutInflater.from(parent.context).inflate(
                R.layout.question_multi_layout,
                parent,
                false
            )
        )
    ...
    override fun onBindViewHolder(holder: QuestionViewHolder, position: Int) {
        ...
        //Opponent
        holder.tvOpponent.text = opponent.name
        Glide.with(context).load(opponent.imageURL).placeholder(R.drawable.ic_anime)
            .into(holder.ivOpponent)
        Glide.with(context).load(userImageURL).placeholder(R.drawable.ic_anime)
            .into(holder.ivUser)
